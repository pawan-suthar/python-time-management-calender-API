...
YOUR_CALENDAR_ID = '' # your calander id 
...
def main():
    ...
    # if argv[1] == 'commit':         # remove comment from line 45-50 and give correct indent
    # for give cmnd threw CLI
    commitHours(creds)
...
def commitHours(creds):
    try:
        ...
        cur.execute("INSERT INTO time VALUES(?, ?, ?);", coding_hours)
        conn.commit()
